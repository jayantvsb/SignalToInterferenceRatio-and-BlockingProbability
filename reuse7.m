...
%Below is the interfering cells coordinates in ij coordinate system without sectoring in reuse-7 condition
interference_x = 2*cosd(30)*R_c*[2 -1 -3 -2 1 3];                    %i-axis coordinates
interference_y = 2*cosd(30)*R_c*[1 3 2 -1 -3 -2];                    %j-axis coordinates
